...
```
여기서 우리는 Reinhard 연산자를 사용하여 HDR 색을 톤 맵핑하고, 가능성 있는 매우 변화하는 방사휘도의 고동적 범위를 유지한 후 색을 감마 보정합니다. 별도의 프레임버퍼나 후처리 단계가 없기 때문에, 우리는 포워드 프래그먼트 셰이더의 끝에서 톤 맵핑과 감마 보정 단계를 직접 적용할 수 있습니다.
